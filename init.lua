...
vim.o.tabstop = 2 -- how wide a tab character looks
vim.o.shiftwidth = 2 -- how wide >> and auto-indent indents
...
-- enable automatic spellcheck for tex and markdown files
